...
import { useGetGroupDocumentsQuery } from "../../../../services/groupApi";
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="space-y-1">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">
              Tài liệu do giảng viên chia sẻ cho nhóm.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6">
        {currentFolder?.folders?.map((f: any) => (
          <div
            ...
            className="group relative rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 p-4 transition hover:shadow-md cursor-pointer"
          >
        ...
        {currentFolder?.files?.map((file: any) => (
          <div
            ...
            className="group relative rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 p-4 transition hover:shadow-md"
          >
            <div className="flex justify-center mb-3">
        ...
        {!currentFolder?.folders?.length && !currentFolder?.files?.length && (
          <div className="col-span-full rounded-2xl border border-dashed border-gray-300 bg-gray-50 py-10 text-center text-gray-500 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400">

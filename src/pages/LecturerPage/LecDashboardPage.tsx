...
import { useGetLecturerProfileQuery } from "../../services/userApi";
...
const LecDashboardPage = () => {
  const { data: lecturerProfileResponse } = useGetLecturerProfileQuery();
  const lecturer = lecturerProfileResponse?.data;
...
export default LecDashboardPage;

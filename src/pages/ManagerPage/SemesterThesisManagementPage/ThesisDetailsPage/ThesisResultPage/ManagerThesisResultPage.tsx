...
const ManagerThesisResultPage = () => {
  ...
  return (
    <div className="space-y-5 mt-6 p-6 bg-white dark:bg-gray-900 rounded-lg border border-gray-300 dark:border-gray-700">
      {/* HEADER */}
      <div className="overflow-hidden pb-6 border-b border-gray-200 dark:border-gray-700">
      ...
      <div>
        ...
        <div className="grid grid-cols-2 gap-3">
          {[
            ...
            <div
              key={label}
              className="flex items-center gap-3 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl px-4 py-3"
            >
        ...
        <div className="divide-y divide-gray-100 dark:divide-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden">
          {defense.council.members.map((m: any) => (
            ...
            >
              ...
              <span className="text-[11px] font-medium px-2 py-0.5 rounded-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-gray-500 dark:text-gray-400 shrink-0">
                {m.role.name}
              </span>
            </div>
          ))}
...
export default ManagerThesisResultPage;
